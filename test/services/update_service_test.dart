...
void main() {
  group('UpdateService', () {
    group('getBinaryUrl', () {
      test(
        'returns Windows installer URL',
        () {
          if (Platform.isWindows) {
            final url = UpdateService.getBinaryUrl('1.0.5');
            expect(
              url,
              'https://github.com/egdata-app/egdata-flutter/releases/download/v1.0.5/egdata-app-1.0.5-setup.exe',
            );
          }
        },
      ...
      test(
        'returns macOS DMG URL',
        () {
          if (Platform.isMacOS) {
            final url = UpdateService.getBinaryUrl('1.0.5');
            expect(
              url,
              'https://github.com/egdata-app/egdata-flutter/releases/download/v1.0.5/egdata-app-1.0.5-macos.dmg',
            );
          }
        },
      ...
      test(
        'returns releases tag URL for unsupported platforms',
        () {
          ...
          if (!Platform.isWindows && !Platform.isMacOS) {
            ...
            expect(
              url,
              'https://github.com/egdata-app/egdata-flutter/releases/tag/v1.0.5',
            );
          }
        },
    ...
    group('version parsing (integration test concept)', () {
      ...
      test('GitHub API URL format', () {
        ...
        final latestUrl =
            '$githubApiBase/repos/$repoOwner/$repoName/releases/latest';
        expect(
          latestUrl,
        ...
        final tagUrl =
            '$githubApiBase/repos/$repoOwner/$repoName/releases/tags/v1.0.5';
        expect(
          tagUrl,
          'https://api.github.com/repos/egdata-app/egdata-flutter/releases/tags/v1.0.5',
        );
      });
    });
    ...
    group('URL construction', () {
      test('Windows URL has correct format', () {
        ...
        const expectedFormat =
            'https://github.com/egdata-app/egdata-flutter/releases/download/v1.2.3/egdata-app-1.2.3-setup.exe';
      ...
      test('macOS URL has correct format', () {
        const version = '1.2.3';
        const expectedFormat =
            'https://github.com/egdata-app/egdata-flutter/releases/download/v1.2.3/egdata-app-1.2.3-macos.dmg';
      ...
      test('fallback URL points to releases tag page', () {
        const version = '1.2.3';
        const expectedFormat =
            'https://github.com/egdata-app/egdata-flutter/releases/tag/v1.2.3';
